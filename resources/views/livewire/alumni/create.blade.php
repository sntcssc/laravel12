<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">Create Alumni Record</h1>
    ...
    <div class="bg-white dark:bg-gray-800 p-4 rounded shadow">
        ...
        <div class="mb-4">
            <label for="completion_date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Completion Date</label>
            <input wire:model="completion_date" type="date" id="completion_date" class="mt-1 block w-full p-2 border rounded dark:bg-gray-700 dark:text-white dark:border-gray-600">
        ...
        <div class="flex space-x-2">
            ...
            <a href="{{ route('alumni.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">Cancel</a>
        </div>
    </div>
